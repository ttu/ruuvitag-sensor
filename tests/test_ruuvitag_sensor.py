...
class TestRuuviTagSensor(TestCase):
    ...
    @patch('ruuvitag_sensor.adaptors.nix_hci.BleCommunicationNix.get_data', get_data)
    @patch('ruuvitag_sensor.adaptors.dummy.BleCommunicationDummy.get_data', get_data)
    ...
    @patch('ruuvitag_sensor.adaptors.dummy.BleCommunicationDummy.get_datas',
           get_datas)
    @patch('ruuvitag_sensor.adaptors.nix_hci.BleCommunicationNix.get_datas',
           get_datas)

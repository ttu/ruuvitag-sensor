...
def try_write_to_influxdb(received_data):
    """
    Call the write_to_influxdb -method and catch any exceptions as any uncaught exception will kill the thread/process
    listening to events from a specific RuuviTag.
    """
    try:
